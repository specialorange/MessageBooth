...
class AudiosControllerTest < ActionController::TestCase
  ...
  test "should create audio" do
    assert_difference('Audio.count') do
      post :create, audio: { datetime: @audio.datetime, integer: @audio.integer, string: @audio.string, string: @audio.string, string: @audio.string }
    end
  ...
  test "should update audio" do
    put :update, id: @audio, audio: { datetime: @audio.datetime, integer: @audio.integer, string: @audio.string, string: @audio.string, string: @audio.string }
    assert_redirected_to audio_path(assigns(:audio))
  end
